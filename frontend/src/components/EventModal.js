...
import { X, Sparkles, Star, ExternalLink, MapPin, Calendar, Clock } from 'lucide-react';
          ...
          <div className="mb-6 space-y-3">
            ...
            {formattedDate && (
              <div className="flex items-center gap-3 text-slate-300">
                ...
                {formattedTime && (
                  <>
                    <Clock size={16} className="text-[#d4af37] shrink-0 ml-2" />
            ...
            {(event.location || event.venue_address) && (
              <div className="flex items-start gap-3 text-slate-300">
                ...
                <div>
                  ...
                  {event.venue_address && (
                    <div className="text-sm text-slate-400">{event.venue_address}</div>
                  )}
                </div>
              </div>
            )}
