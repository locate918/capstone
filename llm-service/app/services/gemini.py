...
{venue_list}
    ...
    - PRESERVE EXISTING OFFSETS: If the input already contains a -05:00 or -06:00 offset,
      copy the ENTIRE datetime value EXACTLY as-is. Do NOT modify the time or the offset.
      Example: input "2026-04-18T21:00:00-05:00" → output "2026-04-18T21:00:00-05:00" unchanged.
    - If the source gives a bare UTC time (ends in Z or +00:00), subtract 5 hours for CDT
      (March-November) or 6 hours for CST (November-March), then apply the correct offset.
      Example: "2026-04-19T02:00:00Z" → "2026-04-18T21:00:00-05:00"
    ...
    - description (string). Rules:
        1. Generate a detailed, engaging description (up to 4-6 sentences or ~500 characters) based on the available text and event attributes. Do not cut off important information        1. ALWAYS generate a concise, engaging summary (max 2-3 sentences) based on the available text and event attributes.
